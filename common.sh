...
{	
	mount | egrep -v " type (proc|devpts|nfs[1234]?|ncp|coda|(a|smb|ci|ncp|usb|tmp|sys|devtmp|debug|config|auto|security|hugetlb)fs|fusectl|cgroup|mqueue|pstore)" | cut -d\  -f3
}
